...
However, until now, you couldn’t easily use this API in a SvelteKit app, since it was difficult to slot into the right place in the navigation lifecycle. SvelteKit 1.24 brought a new [`onNavigate`](/docs/kit/$app-navigation#onNavigate) lifecycle hook to make view transitions integration much easier – let’s dive in.
